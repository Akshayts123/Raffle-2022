...
class _QRScannerState extends State<QRScanner> {
  ...
  Widget build(BuildContext context) {
    ...
    return   WillPopScope(
      ...
      child: Scaffold(
        ...
        //   title: Text("Scan any qr code",style: GoogleFonts.poppins(color: Colors.white),),
        //   centerTitle: true,
        // ),
  ...
  Widget _appbars(BuildContext context) {
    return SafeArea(
      child: Container(

        height: 60,
        decoration: BoxDecoration( color: Style.systemblue,borderRadius: BorderRadius.only(bottomLeft: Radius.circular(25),bottomRight: Radius.circular(25))),
        child: Center(child: Text("Scan any QR code",style: GoogleFonts.poppins(color: Colors.white),)),
      ),
    );
  }
